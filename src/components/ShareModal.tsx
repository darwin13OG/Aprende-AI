...
export const ShareModal: React.FC<ShareModalProps> = ({
  ...
  // Generate URL whenever experience or selectedType changes
  useEffect(() => {
    if (!experience) return;

    const payload = buildSanitizedSharePayload(experience, selectedType);
    const domain = 'https://aprendeai.pages.dev';
  ...
  const handleOpenPreview = () => {
    ...
    const targetUrl = generatedUrl.replace('https://aprendeai.pages.dev', window.location.origin);
